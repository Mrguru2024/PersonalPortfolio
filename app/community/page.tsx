        ...
        <div className="container relative mx-auto px-4 py-16 sm:py-24 lg:py-32">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground sm:text-xl">
              A premium space for founders, builders, and business owners to connect, discuss, collaborate, and grow—backed by the same team that builds brands and tech for growth.
            </p>
              ...
              {!isLoading && user ? (
                <>
                  ...
                  <Button asChild variant="outline" size="lg" className="gap-2">
                    <Link href="/community/profile">Your profile</Link>
                  </Button>
                </>
              ) : (
                <>
                  <Button asChild size="lg" className="gap-2">
                    <Link href="/auth?redirect=/community/onboarding">
                      Join the network
                    </Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="gap-2">
      ...
      <section className="container mx-auto px-4 py-16 sm:py-24">
        <Card className="mx-auto max-w-2xl border-primary/20 bg-primary/5">
          ...
          <CardContent className="flex justify-center">
            {!isLoading && !user && (
              <Button asChild size="lg" className="gap-2">
                <Link href="/auth?redirect=/community/onboarding">Join Ascendra Founder Network</Link>
              </Button>
            )}
            {!isLoading && user && (
              <Button asChild size="lg" variant="outline" className="gap-2">
                <Link href="/community/feed">Go to community feed</Link>
              </Button>
            )}
          </CardContent>
        </Card>
