...
import { Mail, Phone, MapPin, Send, Loader2 } from "lucide-react/dist/esm/index";
import {
  Form,
  FormControl,
  FormDescription,
...
// Contact form schema (similar to the one in shared/schema.ts)
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="section bg-background relative overflow-hidden">
            ...
            >
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="p-3 bg-background rounded-full border border-border hover:border-primary hover:text-primary transition-colors"
                ...
                <a 
                  href="https://linkedin.com/in/anthonyfeaster" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-background rounded-full border border-border hover:border-primary hover:text-primary transition-colors"
      ...
      <div className="absolute -z-10 -left-40 -top-40 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
    </section>
  );
}