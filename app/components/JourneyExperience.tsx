...
export default function JourneyExperience({ activeSection }: JourneyExperienceProps) {
  ...
  const milestones: Milestone[] = [
    ...
    },
    {
      ...
      label: 'Let\'s Connect',
      position: 20,
      icon: <span data-lucide="send" aria-hidden="true"><Send className="text-purple-400" size={20} /></span>,
    ...
    },
    {
      ...
      position: 5,
      icon: <span data-lucide="cpu" aria-hidden="true"><Cpu className="text-primary" size={20} /></span>,
