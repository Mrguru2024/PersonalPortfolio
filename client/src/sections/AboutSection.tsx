        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              creating web and mobile applications. My journey in technology
              began with a Computer Science degree, followed by work at
              innovative startups and established tech companies.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              I specialize in building robust, user-friendly applications using
              modern technologies. My approach combines technical excellence
              with an eye for design and a focus on delivering exceptional user
              experiences.
            </p>
            ...
            <a href="/resume" className="inline-block">
              <Button
                size="lg"
                className="inline-flex items-center gap-2 shadow-md hover:shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-sm sm:text-base w-full sm:w-auto min-h-[44px]"
              >
