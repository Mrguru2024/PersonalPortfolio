...
const FloatingNavigation = dynamic(() => import('./components/FloatingNavigation'), { ssr: false });
const JourneyExperience = dynamic(() => import('./components/JourneyExperience'), { ssr: false });
