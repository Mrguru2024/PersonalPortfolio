...
const AuthPageNext = () => {
  ...
  const { user, isAuthenticated, login, loginWithGithub } = useNextAuth();
  ...
  const onRegister = async (values: RegisterFormValues) => {
    ...
    try {
      // Call the API directly for registration since NextAuth doesn't have a built-in register function
              ...
              <Card>
                ...
                <CardFooter className="flex flex-col space-y-4">
                  ...
                  <div className="w-full">
                    <Button 
                      type="button" 
                      className="w-full bg-[#24292e] hover:bg-[#1a1e22] text-white flex items-center justify-center gap-2"
                      variant="outline"
