...
const STARTER_ROWS = [
  ...
  },
  {
    ...
    displayName: "Ascendra homepage",
    isActive: true,
    urgencyMode: "weekly_review" as const,
    scarcityMode: "manual_review" as const,
    capacitySource: "none" as const,
    manualReviewLabel: "New engagements reviewed weekly",
    proofTitle: "Why we structure intake this way",
    proofBulletsJson: [
      "We cap how many new builds we take on at once so strategy, design, and implementation stay coordinated—not handed off to a queue.",
      "A short review step means your first call is about fit and priorities, not repeating everything on the website.",
    ],
    lossTitle: "When growth work stays vague",
    lossBulletsJson: [
      "Teams that never pick a clear first move often pay for partial fixes that do not compound.",
      "Without a shared diagnosis, agencies and founders talk past each other on scope and timeline.",
    ],
    defaultCtaVariantKey: "default",
    ctaVariantsJson: [] as { key: string; primaryText: string; subText?: string; href: string }[],
    prerequisiteSurfaceKey: null,
