...
export const SITE_DIRECTORY_ENTRIES: SiteDirectoryEntry[] = [
  ...
  { path: "/book/[slug]", title: "Book by meeting type", category: "Public · Marketing", audience: "public", description: "Dynamic booking page for a selected meeting type.", keywords: k("book", "calendar", "meeting type"), cluster: "conversion-primary", relatedPaths: ["/book", "/strategy-call"] },
  { path: "/book/manage/[token]", title: "Manage booking", category: "Public · Marketing", audience: "token", description: "Tokenized booking management: reschedule or cancel an appointment.", keywords: k("booking", "manage", "reschedule", "cancel", "token"), relatedPaths: ["/book", "/strategy-call"] },
  ...
  { path: "/Afn/home", title: "Community dashboard", category: "Public · Community", audience: "public", description: "Signed-in AFN home with recommendations and next actions.", keywords: k("community", "home", "dashboard") },
  { path: "/Afn/speed-networking", title: "Speed networking", category: "Public · Community", audience: "public", description: "Structured networking sessions for AFN members.", keywords: k("community", "networking", "speed networking") },
  { path: "/Afn/tribes", title: "Tribes", category: "Public · Community", audience: "public", description: "Small-group matchmaking and tribe discovery area.", keywords: k("community", "tribes", "groups") },
  { path: "/Afn/projects", title: "Community projects", category: "Public · Community", audience: "public", description: "Project-based collaboration board extension for AFN members.", keywords: k("community", "projects", "collaboration") },
  ...
  { path: "/growth-system", title: "Client growth system", category: "Public · Client portal", audience: "client", description: "Outcome-framed 3-step snapshot (diagnose → build → scale) for eligible portal clients; not a results guarantee.", keywords: k("growth", "client", "snapshot", "gos"), relatedPaths: ["/growth-system/diagnose", "/growth-system/scale", "/growth-system/conversion-diagnostics", "/growth-system/improvements", "/growth-system/page-behavior", "/dashboard", "/growth-diagnosis"] },
  ...
  { path: "/resume", title: "Resume (legacy redirect)", category: "Public · Marketing", audience: "public", description: "Legacy URL now redirected to contact.", keywords: k("resume", "redirect"), relatedPaths: ["/contact"] },
  ...
  { path: "/admin/email-hub/scheduled", title: "Email Hub · Scheduled", category: "Admin · Communications", audience: "admin", description: "Scheduled outbound emails and send queue.", keywords: k("email", "scheduled") },
  { path: "/admin/email-hub/sent", title: "Email Hub · Sent", category: "Admin · Communications", audience: "admin", description: "Outbound send history and delivery status.", keywords: k("email", "sent", "history") },
  { path: "/admin/email-hub/templates", title: "Email Hub · Templates", category: "Admin · Communications", audience: "admin", description: "Email template library.", keywords: k("email", "templates") },
  { path: "/admin/email-hub/templates/new", title: "Email Hub · New template", category: "Admin · Communications", audience: "admin", description: "Create a reusable email template.", keywords: k("email", "template", "new") },
  { path: "/admin/email-hub/templates/[id]/edit", title: "Email Hub · Edit template", category: "Admin · Communications", audience: "admin", description: "Edit an existing email template.", keywords: k("email", "template", "edit") },
  { path: "/admin/email-hub/assets", title: "Email Hub · Assets", category: "Admin · Communications", audience: "admin", description: "Brand/media assets for email composition.", keywords: k("email", "assets", "brand") },
  { path: "/admin/email-hub/tracking", title: "Email Hub · Tracking", category: "Admin · Communications", audience: "admin", description: "Open/click and engagement tracking for email sends.", keywords: k("email", "tracking", "analytics") },
  { path: "/admin/email-hub/settings", title: "Email Hub · Settings", category: "Admin · Communications", audience: "admin", description: "Sender configuration and integration settings for Email Hub.", keywords: k("email", "settings", "sender") },
  { path: "/admin/communications", title: "Communications hub", category: "Admin · Communications", audience: "admin", description: "Campaign and design operations for outbound communications.", keywords: k("communications", "campaigns", "email") },
  { path: "/admin/communications/analytics", title: "Communications analytics", category: "Admin · Communications", audience: "admin", description: "Performance metrics for communications campaigns.", keywords: k("communications", "analytics", "campaigns") },
  { path: "/admin/communications/campaigns", title: "Communications campaigns", category: "Admin · Communications", audience: "admin", description: "Manage communications campaign list and status.", keywords: k("communications", "campaigns") },
  { path: "/admin/communications/campaigns/new", title: "New communications campaign", category: "Admin · Communications", audience: "admin", description: "Create a new communications campaign.", keywords: k("communications", "campaign", "new") },
  { path: "/admin/communications/campaigns/[id]", title: "Communications campaign detail", category: "Admin · Communications", audience: "admin", description: "View and edit a communications campaign.", keywords: k("communications", "campaign", "detail") },
  { path: "/admin/communications/designs", title: "Communications designs", category: "Admin · Communications", audience: "admin", description: "Design assets/templates used across campaigns.", keywords: k("communications", "designs") },
  { path: "/admin/communications/designs/new", title: "New communications design", category: "Admin · Communications", audience: "admin", description: "Create a communications design template.", keywords: k("communications", "design", "new") },
  { path: "/admin/communications/designs/[id]", title: "Communications design detail", category: "Admin · Communications", audience: "admin", description: "View and edit a communications design.", keywords: k("communications", "design", "detail") },
  ...
  { path: "/admin/newsletters/[id]/edit", title: "Edit newsletter", category: "Admin · Content", audience: "admin", description: "Dedicated edit route for newsletter campaigns.", keywords: k("newsletter", "edit") },
  ...
  { path: "/admin/brand-vault", title: "Brand vault", category: "Admin · Content", audience: "admin", description: "Brand files and reusable visual assets.", keywords: k("brand", "assets", "vault") },
  ...
  { path: "/admin/scheduler/calendar", title: "Scheduler · Calendar", category: "Admin · Growth OS", audience: "admin", description: "Master scheduling calendar across hosts and bookings.", keywords: k("scheduler", "calendar") },
  { path: "/admin/scheduler/appointments", title: "Scheduler · Appointments", category: "Admin · Growth OS", audience: "admin", description: "Appointment inbox and management view.", keywords: k("scheduler", "appointments") },
  { path: "/admin/scheduler/booking-pages", title: "Scheduler · Booking pages", category: "Admin · Growth OS", audience: "admin", description: "Shareable booking pages and controls.", keywords: k("scheduler", "booking pages") },
  { path: "/admin/scheduler/event-types", title: "Scheduler · Meeting types", category: "Admin · Growth OS", audience: "admin", description: "Event type configuration for bookings.", keywords: k("scheduler", "meeting types", "event types") },
  { path: "/admin/scheduler/availability", title: "Scheduler · Availability", category: "Admin · Growth OS", audience: "admin", description: "Availability windows and scheduling constraints.", keywords: k("scheduler", "availability") },
  { path: "/admin/scheduler/team", title: "Scheduler · Team", category: "Admin · Growth OS", audience: "admin", description: "Host/team setup for scheduling assignment.", keywords: k("scheduler", "team") },
  { path: "/admin/scheduler/routing-rules", title: "Scheduler · Routing rules", category: "Admin · Growth OS", audience: "admin", description: "Lead-to-calendar routing rules and assignment logic.", keywords: k("scheduler", "routing", "rules") },
  { path: "/admin/scheduler/workflows", title: "Scheduler · Workflows", category: "Admin · Growth OS", audience: "admin", description: "Booking automation workflows and reminders.", keywords: k("scheduler", "workflows", "automation") },
  { path: "/admin/scheduler/payments", title: "Scheduler · Payments", category: "Admin · Growth OS", audience: "admin", description: "Payment settings for paid booking flows.", keywords: k("scheduler", "payments") },
  { path: "/admin/scheduler/analytics", title: "Scheduler · Analytics", category: "Admin · Growth OS", audience: "admin", description: "Scheduling performance metrics and reports.", keywords: k("scheduler", "analytics", "reports") },
  { path: "/admin/scheduler/settings", title: "Scheduler · Settings", category: "Admin · Growth OS", audience: "admin", description: "Global scheduler settings and defaults.", keywords: k("scheduler", "settings") },
  { path: "/admin/scheduling/availability", title: "Scheduling setup · Availability", category: "Admin · Growth OS", audience: "admin", description: "Configure default availability templates.", keywords: k("scheduling", "availability") },
  { path: "/admin/scheduling/booking-types", title: "Scheduling setup · Booking types", category: "Admin · Growth OS", audience: "admin", description: "Configure booking type templates and defaults.", keywords: k("scheduling", "booking types") },
  { path: "/admin/scheduling/my-availability", title: "Scheduling setup · My availability", category: "Admin · Growth OS", audience: "admin", description: "Personal host availability management.", keywords: k("scheduling", "my availability") },
  { path: "/admin/scheduling/settings", title: "Scheduling setup · Settings", category: "Admin · Growth OS", audience: "admin", description: "Scheduling setup and reminder defaults.", keywords: k("scheduling", "settings") },
  {
  ...
  {
    path: "/admin/growth-os/market-research",
    title: "Ascendra Market Research Engine",
    category: "Admin · Growth OS",
    audience: "admin",
    description:
      "Structured market research projects: intake, source setup, runs, evidence scoring, recommendations, and decision reports.",
    keywords: k(
      "market research",
      "research engine",
      "scoring engine",
    ...
    relatedPaths: ["/admin/growth-os/intelligence", "/admin/market-intelligence", "/admin/crm", "/admin/paid-growth"],
  },
  ...
  { path: "/admin/growth-engine/revenue", title: "Growth engine — Revenue", category: "Admin · Ops", audience: "admin", description: "Revenue signals and attribution diagnostics.", keywords: k("growth engine", "revenue", "attribution") },
  { path: "/admin/growth-engine/automations", title: "Growth engine — Automations", category: "Admin · Ops", audience: "admin", description: "Rules and workflow automations for growth operations.", keywords: k("growth engine", "automations", "workflows") },
  { path: "/admin/growth-engine/alerts", title: "Growth engine — Alerts", category: "Admin · Ops", audience: "admin", description: "Operational alerting for growth and revenue signals.", keywords: k("growth engine", "alerts") },
  { path: "/admin/growth-engine/calls", title: "Growth engine — Calls", category: "Admin · Ops", audience: "admin", description: "Call quality and call outcome monitoring workspace.", keywords: k("growth engine", "calls") },
  { path: "/admin/growth-engine/knowledge", title: "Growth engine — Knowledge", category: "Admin · Ops", audience: "admin", description: "Internal growth intelligence knowledge base.", keywords: k("growth engine", "knowledge") },
  { path: "/admin/growth-engine/roi", title: "Growth engine — ROI", category: "Admin · Ops", audience: "admin", description: "ROI input and outcome modeling workspace.", keywords: k("growth engine", "roi") },
  { path: "/admin/growth-engine/funnel-canvas", title: "Growth engine — Funnel canvas", category: "Admin · Ops", audience: "admin", description: "Editable funnel blueprint canvas tied to behavior data.", keywords: k("growth engine", "funnel", "canvas") },
  ...
  { path: "/admin/behavior-intelligence/replays", title: "Behavior Intelligence — Replays", category: "Admin · Ops", audience: "admin", description: "Watch visitor session recordings by choosing a visit or searching pages—no technical IDs required.", keywords: k("replay", "session"), relatedPaths: ["/admin/behavior-intelligence/visitors"] },
  ...
  {
    path: "/admin/behavior-intelligence/surveys",
    title: "Behavior Intelligence — Surveys",
    category: "Admin · Ops",
    audience: "admin",
    description: "Survey builder with triggers, tuning, responses, search, and CSV export.",
    keywords: k("survey", "feedback", "micro-survey"),
  },
  {
    path: "/admin/behavior-intelligence/phone-tracking",
    title: "Behavior Intelligence — Phone tracking",
    category: "Admin · Ops",
    audience: "admin",
    description:
      "Twilio-backed call logging for registered numbers; optional recording URL playback and CRM match.",
    keywords: k("phone", "calls", "twilio", "recording", "tracking"),
    relatedPaths: ["/admin/growth-os/revenue-ops", "/admin/crm"],
  },
  {
    path: "/admin/behavior-intelligence/user-tests",
    title: "Behavior Intelligence — User tests",
    category: "Admin · Ops",
    audience: "admin",
    description: "Campaigns with hypotheses, session-linked notes, CRM links, filters, visit window, CSV export.",
    keywords: k("user test", "research", "qualitative"),
  },
  ...
  { path: "/admin/paid-growth/readiness", title: "Paid Growth — Readiness", category: "Admin · Ops", audience: "admin", description: "Readiness checks before campaign launch.", keywords: k("paid growth", "readiness") },
  { path: "/admin/paid-growth/accounts", title: "Paid Growth — Accounts", category: "Admin · Ops", audience: "admin", description: "Connected ad account management.", keywords: k("paid growth", "accounts", "ads") },
  { path: "/admin/paid-growth/reports", title: "Paid Growth — Reports", category: "Admin · Ops", audience: "admin", description: "Campaign reporting and performance views.", keywords: k("paid growth", "reports", "analytics") },
  { path: "/admin/paid-growth/lead-quality", title: "Paid Growth — Lead quality", category: "Admin · Ops", audience: "admin", description: "Lead quality scoring and verification outcomes.", keywords: k("paid growth", "lead quality") },
  { path: "/admin/paid-growth/campaigns", title: "Paid Growth — Campaigns", category: "Admin · Ops", audience: "admin", description: "Campaign list and status management.", keywords: k("paid growth", "campaigns") },
  { path: "/admin/paid-growth/campaigns/new", title: "Paid Growth — New campaign", category: "Admin · Ops", audience: "admin", description: "Create a new paid-growth campaign.", keywords: k("paid growth", "campaign", "new") },
  { path: "/admin/paid-growth/campaigns/[id]", title: "Paid Growth — Campaign detail", category: "Admin · Ops", audience: "admin", description: "Campaign configuration and diagnostics detail.", keywords: k("paid growth", "campaign", "detail") },
  {
  ...
  { path: "/admin/agency-os/projects/[id]", title: "Agency OS — Project detail", category: "Admin · Ops", audience: "admin", description: "Single delivery project workspace with milestones and linked execution items.", keywords: k("agency", "project", "detail", "delivery") },
  {
  ...
  { path: "/admin/community/live-access", title: "Community live access", category: "Admin · Ops", audience: "admin", description: "Live community room access and moderation controls.", keywords: k("community", "live", "access") },
  { path: "/admin/community/scoring", title: "Community scoring", category: "Admin · Ops", audience: "admin", description: "Scoring controls for community participation and matchmaking.", keywords: k("community", "scoring", "matchmaking") },
];
