...
function log(message) {
  console.log(`[static-api] ${message}`);
}
...
function writeJsonFile(filename, data) {
  ...
  if (!fs.existsSync(distApiDir)) {
    ...
    log(`Created directory: ${distApiDir}`);
  }
  
  const filePath = path.join(distApiDir, filename);
  ...
  const projects = [
    {
      id: "1",
      title: "Stackzen",
      description: "Intelligent income and expense tracking platform with financial insights.",
      image_url: "/assets/project-stackzen.webp",
      live_url: "https://www.stackzen.app",
      github_url: "https://github.com/Mrguru2024/IncomeIntelligence",
    ...
    },
    {
      id: "2",
      title: "Keycode Help",
      description: "SaaS platform for VIN-to-keycode services and locksmith resources.",
