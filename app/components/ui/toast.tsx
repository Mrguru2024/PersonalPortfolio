...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-0 right-0 z-[100] flex max-h-[100dvh] w-full flex-col-reverse p-3 pt-[max(0.75rem,env(safe-area-inset-top))] sm:left-auto sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:max-w-[420px] sm:p-4 sm:pt-4 md:max-w-[420px]",
      className
    )}
    {...props}
  />
