...
export const SITE_DIRECTORY_ENTRIES: SiteDirectoryEntry[] = [
  ...
  { path: "/admin/behavior-intelligence", title: "Behavior Intelligence", category: "Admin · Ops", audience: "admin", description: "Session replay, heatmaps, surveys, friction (extends visitor tracking).", keywords: k("behavior", "replay", "heatmap", "friction", "analytics"), relatedPaths: ["/admin/analytics", "/admin/behavior-intelligence/replays"] },
  { path: "/admin/behavior-intelligence/replays", title: "Behavior Intelligence — Replays", category: "Admin · Ops", audience: "admin", description: "rrweb session replay viewer.", keywords: k("replay", "session") },
  { path: "/admin/behavior-intelligence/heatmaps", title: "Behavior Intelligence — Heatmaps", category: "Admin · Ops", audience: "admin", description: "Heatmap ingestion notes and future overlay.", keywords: k("heatmap", "clicks") },
  ...
  { path: "/admin/paid-growth/campaigns/[id]/structure", title: "Campaign structure (ad groups)", category: "Admin · Ops", audience: "admin", description: "Ad groups, keywords, destinations, copy variants for a PPC campaign.", keywords: k("ad groups", "keywords", "ppc", "structure") },
  {
    ...
    relatedPaths: ["/admin/agency-os/hvd", "/admin/agency-os/tasks", "/admin/crm", "/admin/growth-platform"],
  },
  {
    ...
    relatedPaths: ["/admin/agency-os", "/admin/agency-os/tasks"],
  },
  {
    ...
    category: "Admin · Ops",
    audience: "admin",
    description: "Internal tasks with pending acceptance; POST acceptance API for accept, decline, or clarification.",
