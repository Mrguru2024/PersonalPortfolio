...
export const SITE_DIRECTORY_ENTRIES: SiteDirectoryEntry[] = [
  ...
  { path: "/dashboard", title: "Client dashboard", category: "Public · Client portal", audience: "client", description: "Signed-in customer dashboard.", keywords: k("dashboard", "client"), relatedPaths: ["/growth-system"] },
  { path: "/growth-system", title: "Client growth system", category: "Public · Client portal", audience: "client", description: "Diagnose / build / scale snapshot for eligible portal clients.", keywords: k("growth", "client", "snapshot", "gos"), relatedPaths: ["/dashboard", "/growth-diagnosis"] },
