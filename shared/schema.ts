...
export const adminInboxItems = pgTable("admin_inbox_items", {
  id: serial("id").primaryKey(),
  /** contact | quote | assessment | free_lead | data_deletion | blog_comment | offer_valuation | growth_funnel | market_score | skill_endorsement | client_feedback | newsletter_subscribe | ... (legacy rows may still use kind resume) */
