...
**Note:** Superseded in part by the ecosystem funnel (see [ECOSYSTEM_FUNNEL_AUDIT.md](ECOSYSTEM_FUNNEL_AUDIT.md)). Homepage is now funnel-led; persona landings and `/audit` remain; primary conversion path is Brand Growth → strategy call.
