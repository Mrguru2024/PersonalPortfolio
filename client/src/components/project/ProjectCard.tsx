...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  const isFeatured =
    project.title.includes("Stackzen") ||
    project.title.includes("Keycode Help");
    ...
    >
      ...
      >
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  variant="default"
                  className="bg-primary hover:bg-primary/90 text-white flex items-center gap-2 group text-sm sm:text-base"
                >
                  <motion.div
                    animate={{
                      rotate: [0, 15, 0],
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.1 }}
        >
          <Badge className="bg-primary/80 hover:bg-primary text-white border-none">
            {project.category}
          </Badge>
        </motion.div>
      </div>
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href={`/projects/${project.id}`}>
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto flex items-center justify-center gap-2 group text-sm sm:text-base min-h-[44px]"
              >
