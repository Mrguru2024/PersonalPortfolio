...
interface SEOPanelProps {
  ...
  onInternalLinksChange: (
    links: Array<{ text: string; url: string; postId?: number }>
  ) => void;
  onExternalLinksChange: (
    links: Array<{ text: string; url: string; nofollow?: boolean }>
  ) => void;
...
export function SEOPanel({
  ...
  const addInternalLink = () => {
    if (internalLinkText && internalLinkUrl) {
      onInternalLinksChange([
        ...internalLinks,
        { text: internalLinkText, url: internalLinkUrl },
      ]);
      setInternalLinkText("");
      setInternalLinkUrl("");
  ...
  const addExternalLink = () => {
    if (externalLinkText && externalLinkUrl) {
      onExternalLinksChange([
        ...externalLinks,
        { text: externalLinkText, url: externalLinkUrl, nofollow: false },
      ]);
      setExternalLinkText("");
      setExternalLinkUrl("");
  ...
  useEffect(() => {
    if (!metaDescription && summary) {
      onMetaDescriptionChange(
        summary.length <= 160 ? summary : summary.substring(0, 157) + "..."
      );
    }
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      Your SEO score is calculated based on best practices: meta
                      tags, content length, internal/external links, images, and
                      social sharing tags. Aim for 80+ for optimal search engine
                      visibility.
                    </p>
                  </TooltipContent>
                </Tooltip>
                ...
                onClick={async () => {
                  ...
                  try {
                    const response = await apiRequest(
                      "POST",
                      "/api/admin/blog/ai/generate-seo",
                      {
                        title,
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Link to other posts on your site to improve SEO and user
                  engagement
                </CardDescription>
              </div>
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      ...
                      structure and keep readers engaged. Aim for 2-5 internal
                      links per post. Link to related, high-quality content.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            {showInternalLinkForm ? (
              <div className="space-y-2 p-4 border rounded">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="button" onClick={addInternalLink}>
                    Add
                  </Button>
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setShowInternalLinkForm(false)}
                  >
                    Cancel
                  </Button>
                </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Add external links to authoritative sources. Use nofollow for
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      External links to authoritative sources build trust with
                      search engines. Use &quot;nofollow&quot; for paid links,
                      sponsored content, or untrusted sources. Regular links
                      pass SEO value to the linked site.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <div className="space-y-2 p-4 border rounded">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setShowExternalLinkForm(false)}
                  >
                    Cancel
                  </Button>
                </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      Open Graph tags control how your post appears when shared
                      on Facebook, LinkedIn, Twitter, etc. Use a 1200x630px
                      image for best results. These tags don&apos;t directly
                      affect SEO but improve click-through rates.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
