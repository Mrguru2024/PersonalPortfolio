...
import { Mail, MapPin, Phone, CheckCircle, Calendar, Clock, ArrowRight, ClipboardCheck, Sparkles, Lightbulb } from "lucide-react";
...
const ContactSection = () => {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Thank you for your interest! I'll review your project details and send you a personalized quote within 24 hours.",
      });
      form.reset();
  ...
  const handleEnhanceWithAI = useCallback(async (field: any) => {
    setIsLoadingAI(true);
    try {
  ...
  return (
    <section id="contact" className="py-12 xs:py-16 sm:py-20 md:py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
      <div className="container mx-auto px-3 fold:px-4 sm:px-4 md:px-6">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-4">
            Ready to take your online presence to the next level? Get a custom quote for your project and let's create a solution that drives results.
          </p>
          ...
          <Card className="bg-white dark:bg-gray-900 border-none shadow-md hover:shadow-lg transition-all">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Each project is built with clean, well-documented code following best practices.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white dark:bg-gray-900 border-none shadow-md hover:shadow-lg transition-all">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Clear timelines and reliable delivery schedules you can count on.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white dark:bg-gray-900 border-none shadow-md hover:shadow-lg transition-all">
            ...
            >
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Project Details</p>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="1-2k">$1,000 - $2,000</SelectItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-xs text-gray-500 dark:text-gray-400">
                          Minimum 10 characters. Be as detailed as possible for an accurate personalized quote.
                        </FormDescription>
                        <FormMessage />
                        <div className="mt-2">
                          <Button
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md p-4 border border-gray-200 dark:border-gray-800">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            Subscribe to my newsletter for web development tips and insights
                          </FormLabel>
                        </div>
                      </FormItem>
                    )}
