...
function RecommendationInner({ enginePricing }: { enginePricing: PublicOfferPricingSnapshot | null }) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-teal-500/[0.04]">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl space-y-8">
        ...
        <div className="space-y-3">
          ...
          <OfferStackTierCards highlightTier={tier} enginePricing={enginePricing} />
        </div>
...
export function GrowthPlatformRecommendationClient({
  enginePricing,
}: {
  ...
  return (
    <Suspense
      fallback={<div className="container mx-auto px-4 py-24 text-center text-muted-foreground">Loading…</div>}
    >
      <RecommendationInner enginePricing={enginePricing} />
    </Suspense>
  );
}
